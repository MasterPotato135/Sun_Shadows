...
public class StreamSettings extends Activity {
    ...
    private void applyHighLevelStreamPreset(int resolution, int fps, int bitrate, boolean mobileNetworkOptimizations,
                                            int jumpFrameMode, int targetLatencyMs, boolean adaptiveResolution,
                                            String framePacing, boolean bitrateOptimization,
                                            int bitrateAnalysisIntervalMs, int frameSimilarityThreshold,
                                            boolean localUpscaling, int localUpscalingMode,
                                            boolean preferAudioOverVideo, int transitionFrameMode,
                                            boolean localFrameDeduplication, boolean localMotionSmoothing) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString("list_resolution", resolution == 0 ? "1280x720" : (resolution == 1 ? "1920x1080" : "2560x1440"));
        editor.putString("list_fps", String.valueOf(fps));
        editor.putInt("seekbar_bitrate_kbps", bitrate);
        editor.putBoolean("checkbox_mobile_network_optimizations", mobileNetworkOptimizations);
        editor.putString("list_jump_frame_mode", String.valueOf(jumpFrameMode));
        editor.putInt("seekbar_target_latency", targetLatencyMs);
        editor.putBoolean("checkbox_adaptive_resolution", adaptiveResolution);
        editor.putString("frame_pacing", framePacing);
        editor.putBoolean("checkbox_bitrate_optimization", bitrateOptimization);
        editor.putInt("seekbar_bitrate_analysis_interval", bitrateAnalysisIntervalMs);
        editor.putInt("seekbar_frame_similarity_threshold", frameSimilarityThreshold);
        editor.putBoolean("checkbox_local_upscaling", localUpscaling);
        editor.putString("list_local_upscaling_mode", String.valueOf(localUpscalingMode));
        editor.putBoolean("checkbox_prefer_audio_over_video", preferAudioOverVideo);
        editor.putString("list_transition_frame_mode", String.valueOf(transitionFrameMode));
        editor.putBoolean("checkbox_local_frame_deduplication", localFrameDeduplication);
        editor.putBoolean("checkbox_local_motion_smoothing", localMotionSmoothing);
        editor.apply();
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_profile_slow_network) {
            applyHighLevelStreamPreset(0, 30, 4000, true, 1, 90, true, "balanced", true, 50, 85, true, 1, true, 1, true, true);
            reloadSettings();
            return true;
        }

        if (item.getItemId() == R.id.menu_profile_balanced) {
            applyHighLevelStreamPreset(1, 30, 6000, true, 1, 70, true, "balanced", true, 50, 85, true, 1, false, 1, true, false);
            reloadSettings();
            return true;
        }

        if (item.getItemId() == R.id.menu_profile_quality) {
            applyHighLevelStreamPreset(1, 60, 10000, false, 0, 60, false, "balanced", false, 50, 85, false, 1, false, 0, false, false);
            reloadSettings();
            return true;
        }

        if (item.getItemId() == R.id.menu_safe_low_bandwidth_profile) {
            applyHighLevelStreamPreset(0, 30, 3500, true, 1, 100, true, "balanced", true, 40, 80, true, 1, true, 1, true, true);
            reloadSettings();
            return true;
        }

        if (item.getItemId() == R.id.menu_local_smoothing_profile) {
            applyHighLevelStreamPreset(1, 30, 5000, true, 1, 80, true, "balanced", true, 50, 85, true, 2, false, 2, true, true);
            reloadSettings();
            return true;
        }

        if (item.getItemId() == R.id.menu_disable_all_4g_optimizations) {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
            SharedPreferences.Editor editor = prefs.edit();
            editor.putBoolean("checkbox_mobile_network_optimizations", false);
            editor.putString("list_jump_frame_mode", "0");
            editor.putInt("seekbar_target_latency", 80);
            editor.putBoolean("checkbox_adaptive_resolution", false);
            editor.putString("frame_pacing", "balanced");
            editor.putBoolean("checkbox_bitrate_optimization", false);
            editor.putInt("seekbar_bitrate_analysis_interval", 50);
            editor.putInt("seekbar_frame_similarity_threshold", 85);
            editor.putBoolean("checkbox_local_upscaling", false);
            editor.putString("list_local_upscaling_mode", "1");
            editor.putBoolean("checkbox_prefer_audio_over_video", false);
            editor.putString("list_transition_frame_mode", "0");
            editor.putBoolean("checkbox_local_frame_deduplication", false);
            editor.putBoolean("checkbox_local_motion_smoothing", false);
            editor.putBoolean("checkbox_4g_packet_loss_recovery", false);
            editor.putBoolean("checkbox_4g_dynamic_bitrate", false);
            editor.putBoolean("checkbox_4g_fec_enabled", false);
            editor.putBoolean("checkbox_4g_bitrate_smoothing", false);
            editor.putBoolean("checkbox_4g_signal_monitoring", false);
            editor.putBoolean("checkbox_4g_quality_adaptation", false);
            editor.putBoolean("checkbox_4g_connection_recovery", false);
            editor.putBoolean("checkbox_4g_packet_prioritization", false);
            editor.putBoolean("checkbox_4g_error_correction", false);
            editor.putBoolean("checkbox_4g_handover_smooth", false);
            editor.putInt("seekbar_4g_buffer_size", 128);
            editor.putString("seekbar_4g_jitter_correction", "0");
            editor.putInt("seekbar_4g_max_latency", 120);
            editor.putString("seekbar_4g_network_priority", "0");
            editor.putInt("seekbar_4g_frame_drop_threshold", 10);
            editor.putString("seekbar_4g_codec_preference", "0");
            editor.putInt("seekbar_4g_recovery_timeout", 2);
            editor.putString("seekbar_4g_congestion_control", "0");
            editor.putInt("seekbar_4g_min_bandwidth", 3000);
            editor.putString("seekbar_4g_stream_profile", "0");
            editor.apply();
            reloadSettings();
            return true;
        }
